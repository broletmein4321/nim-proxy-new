...
// 🛑 THE FIX: Listen to Railway's injected Port variable
// If Railway says jump, we say "How high?"
...
// This ensures that no matter what path Railway pings, we say "OK"
app.get('/', (req, res) => res.status(200).send('Proxy Alive'));
